...
object DatabaseUtil {
    ...
    fun insertMockData(context: Context) {
        ...
        db.execSQL("INSERT INTO schedule (id, type, region_id, title, memo, lat, lng, start_datetime, end_datetime, created_at) VALUES (5, 'HOTEL', 1, 'Stay at a hotel in Versailles', 'Book in advance for better rates', 48.8049, 2.1204, '2024-05-03T18:00:00Z', '2024-05-03T20:00:00Z', '2024-04-01T12:00:00Z');")
